...
<div class="mrow">
<div class="mfield">
<div class="flabel">Preço (unit)</div>
<div class="pill editing-cell">
<span class="pvalue" data-view>${fmtMoney(unit)}</span>
<button
                       class="icon-btn"
                       title="Editar preço"
                       data-action="edit-cell"
...
<div class="mfield">
<div class="flabel">Quantidade</div>
<div class="pill qtybox">
<button class="qtybtn" title="Diminuir" data-action="qty-step" data-id="${it.id}" data-delta="-1">−</button>
<div class="qtynum">${qtd}</div>
<button class="qtybtn" title="Aumentar" data-action="qty-step" data-id="${it.id}" data-delta="1">+</button>
</div>
</div>
</div>
<div class="mactions">
...
<button class="btn small danger" data-action="delete" data-id="${it.id}">Excluir</button>
<button
                   class="btn small ${isBought ? "warn" : "primary"}"
                   data-action="toggle-status"
                   data-id="${it.id}"
                   data-next="${next}"
>
                   ${isBought ? "↩️ Pendente" : "✔ Comprado"}
</button>
</div>
</div>
</div>
